...
func main() {
	...
	t = time.Now()
	PrintArrays(InvertedSuffix.SortedErrorCorrectingQuery("tsst", 5, Correction, LengthSorter))
	fmt.Println("Performed sorted error correcting search in:", time.Now().Sub(t))
	t = time.Now()
	PrintArrays(InvertedSuffix.SortedErrorCorrectingQuery("tsst", 5, Correction, FreqSorter))
	fmt.Println("Performed sorted error correcting search in:", time.Now().Sub(t))
	t = time.Now()
	PrintArrays(InvertedSuffix.SortedQuery("a", 5, LengthSorter))
	...
	t = time.Now()
	PrintArrays(SIS.Query("ar", 5))
	fmt.Println("Performed sorted search in:", time.Now().Sub(t))
	t = time.Now()
	PrintArrays(SIS.Query("test", 5))
	fmt.Println("Performed sorted search in:", time.Now().Sub(t))
	t = time.Now()
	PrintArrays(SIS.ErrorCorrectingQuery("tsst", 5, Correction))
	fmt.Println("Performed sorted error correcting search in:", time.Now().Sub(t))
	t = time.Now()
	PrintArrays(SIS.Query("a", 5))
	fmt.Println("Performed sorted search in:", time.Now().Sub(t))
	t = time.Now()
	PrintArrays(SIS.Query("the", 25))
	fmt.Println("Performed sorted search in:", time.Now().Sub(t))
	t = time.Now()
	SIS.Insert("asdfghjklqwertyuiopzxcvbnm")
	fmt.Println("Performed insert in:", time.Now().Sub(t))
	t = time.Now()
	PrintArrays(SIS.Query("sdfghjklqwert", 5))
	fmt.Println("Performed sorted search in:", time.Now().Sub(t))
	t = time.Now()
}
